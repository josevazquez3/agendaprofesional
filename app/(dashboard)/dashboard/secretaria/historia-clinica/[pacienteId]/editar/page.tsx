...
export default function EditarHistoriaClinicaSecretariaPage() {
                    ...
                    <>
                      ...
                      {registro.diagnostico && (
                        <div>
                          ...
                          <p className="text-gray-700 whitespace-pre-wrap">{registro.diagnostico}</p>
                        </div>
                      )}
                      {registro.tratamiento && (
                        <div>
                          <h4 className="font-semibold mb-2">Tratamiento</h4>
                          <p className="text-gray-700 whitespace-pre-wrap">{registro.tratamiento}</p>
                        </div>
                      )}
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            {registro.archivos.map((archivo) => (
                              ...
                              >
                                ...
                                <span className="text-xs text-gray-500">({archivo.tipoArchivo})</span>
                              </a>
                            ))}
                          </div>
                        </div>
