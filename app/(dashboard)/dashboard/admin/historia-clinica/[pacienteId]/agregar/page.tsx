...
export default function AgregarHistoriaClinicaPage() {
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      router.push(`/dashboard/admin/historia-clinica/${pacienteId}`)
      router.refresh()
    } catch (err: any) {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          <Link href={`/dashboard/admin/historia-clinica/${pacienteId}`}>
